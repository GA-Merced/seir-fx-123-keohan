...
title: "Space Battle in Python"
week: 20
day: 2
type: "lab"
---

Title: Space Battle (Python Version)<br>
Type: Workshop<br>
...
Today you will be using your knowledge of OOP, loops, and functions to build a rudimentary **space battle** game. The game will be programmed for, and played in the console. You will need to receive user input.
...
**NOTE**
- You will write your code in spacebattle.py, use the comments to known what logic belongs in what function.
- There is a suite of tests to test you can run to make sure the different functions are doing what they supposed, these can be run with the command `pytest` assuming pytest is installed.
- run play.py to play the game when complete `python play.py`
...
* **accuracy** is the chance between 0 and 1 that the ship will hit its target.
 - Every time the ship will attack, calculate the chance that the damage will hit the opposing ship using (how to make random numbers?)
 - If the ship's accuracy is `0.8` - then if the number generated is less than or equal to `0.8` then the attack will be successful. If the value is greater than  `0.8` then the attack has missed. 
