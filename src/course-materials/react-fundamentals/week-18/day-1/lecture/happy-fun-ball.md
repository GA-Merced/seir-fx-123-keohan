...
# Happy Fun Ball - Git Branches and Merging
...
`nothing to commit, working tree clean`
  ...
  `origin    git@generalassemb.ly:your-github-handle/hfb.git (fetch)`<br>
   `origin    git@generalassemb.ly:your-github-handle/hfb.git (push)`
